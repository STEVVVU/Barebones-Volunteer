document.addEventListener('DOMContentLoaded', function() {
    ...
    // Function to fetch and download PDF report
    function fetchPdfReport() {
        fetch('http://localhost:3000/api/report/pdf', {
            method: 'GET',
            headers: {
        ...
        .then(data => {
            downloadFile(data, 'volunteer_report.pdf');
        })
        .catch(error => {
    ...
    // Function to fetch and download CSV report
    function fetchCsvReport() {
        fetch('http://localhost:3000/api/report/csv', {
            method: 'GET',
            headers: {
        ...
        .then(response => response.blob())
        .then(data => {
            downloadFile(data, 'volunteer_report.csv');
        })
        .catch(error => {
    ...
    document.getElementById('download-pdf-report').addEventListener('click', fetchPdfReport);
    document.getElementById('download-csv-report').addEventListener('click', fetchCsvReport);
});
